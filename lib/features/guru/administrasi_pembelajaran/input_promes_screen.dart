...
/// Screen untuk input Program Semester (Promes)
/// Menyimpan data ke tabel Program_Semester dengan struktur:
/// - promes_id
/// - user_id
/// - kelas_id
/// - mata_pelajaran_id
...
/// TODO: Metadata file disimpan di Firestore (tabel Program_Semester)
/// TODO: Validasi file hanya PDF dan ukuran maksimal
class InputPromesScreen extends StatefulWidget {
  const InputPromesScreen({super.key});

  @override
  State<InputPromesScreen> createState() => _InputPromesScreenState();
}

class _InputPromesScreenState extends State<InputPromesScreen> {
  // Form key
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Input Program Semester'),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            'Upload program semester pembelajaran per semester',
                            style: TextStyle(
                              color: AppColors.warning,
                              fontSize: 14,
                            ),
  ...
  void _handleFileUpload() {
    ...
    setState(() {
      _selectedFileName = 'Promes_${_selectedMataPelajaran ?? 'Dokumen'}_${_selectedKelas ?? ''}_2025.pdf';
    });
  ...
  /// TODO: Simpan metadata ke Firestore (tabel Program_Semester)
  void _handleSimpan() {
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Simpan program semester dengan data:'),
              const SizedBox(height: 12),
  ...
  /// Save program semester
  /// TODO: Implement actual save to Firestore
  Future<void> _savePromes() async {
    ...
    messenger.showSnackBar(
      const SnackBar(
        content: Text('Program Semester berhasil disimpan'),
        backgroundColor: AppColors.success,
        duration: Duration(seconds: 2),
      ),
    );
