...
/// Screen untuk input Rencana Pelaksanaan Pembelajaran (RPP)
/// Menyimpan data ke tabel Rencana_Pembelajaran dengan struktur:
/// - rpp_id
/// - user_id
/// - kelas_id
/// - mata_pelajaran_id
...
/// TODO: Metadata file disimpan di Firestore (tabel Rencana_Pembelajaran)
/// TODO: Validasi file hanya PDF dan ukuran maksimal
class InputRencanaPembelajaranScreen extends StatefulWidget {
  const InputRencanaPembelajaranScreen({super.key});

  @override
  State<InputRencanaPembelajaranScreen> createState() => _InputRencanaPembelajaranScreenState();
}

class _InputRencanaPembelajaranScreenState extends State<InputRencanaPembelajaranScreen> {
  // Form key
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Input Rencana Pembelajaran'),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            'Upload RPP (Rencana Pelaksanaan Pembelajaran) per semester',
                            style: TextStyle(
                              color: Colors.purple,
                              fontSize: 14,
                            ),
                ...
                // Section title
                const Text(
                  'Informasi Rencana Pembelajaran',
                  style: TextStyle(
                    fontSize: 18,
  ...
  void _handleFileUpload() {
    ...
    setState(() {
      _selectedFileName = 'RPP_${_selectedMataPelajaran ?? 'Dokumen'}_${_selectedKelas ?? ''}_2025.pdf';
    });
  ...
  /// TODO: Simpan metadata ke Firestore (tabel Rencana_Pembelajaran)
  void _handleSimpan() {
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text('Simpan RPP dengan data:'),
              const SizedBox(height: 12),
  ...
  Future<void> _saveRpp() async {
    ...
    messenger.showSnackBar(
      const SnackBar(
        content: Text('RPP berhasil disimpan'),
        backgroundColor: AppColors.success,
        duration: Duration(seconds: 2),
      ),
    );
